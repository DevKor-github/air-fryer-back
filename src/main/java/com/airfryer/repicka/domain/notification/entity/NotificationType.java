...
public enum NotificationType
{
    ...
    APPOINTMENT_RENTAL_REMIND("약속 대여 리마인드 알림", "'%s' PICK 대여(구매) 날짜가 다가오고 있습니다! 잊지 말고 준비해주세요."),
    APPOINTMENT_RETURN_REMIND("약속 반납 리마인드 알림", "'%s' PICK 반납 날짜가 다가오고 있습니다! 잊지 말고 준비해주세요."),
    APPOINTMENT_CANCEL("약속 취소 알림", "'%s'님이 약속을 취소하였습니다."),
    APPOINTMENT_REJECT("약속 거절 알림", "'%s'님이 약속을 거절하였습니다."),
    APPOINTMENT_EXPIRE("약속 만료 알림", "'%s' PICK 날짜가 만료되었습니다."),
    APPOINTMENT_SUCCESS("약속 완료 알림", "'%s' PICK이 완료되었습니다."),
