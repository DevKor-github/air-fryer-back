...
@Getter
public class OfferAppointmentReq
{
    ...
    private LocalDateTime startDate;    // 대여(구매) 시작 일시

    @Future(message = "반납 일시는 현재보다 미래여야 합니다.")
    private LocalDateTime endDate;      // 반납 일시

    @Size(max = 255, message = "대여 장소는 최대 255자까지 입력할 수 있습니다.")
    private String startLocation;       // 대여(구매) 장소

    @Size(max = 255, message = "반납 장소는 최대 255자까지 입력할 수 있습니다.")
    private String endLocation;         // 반납 장소
